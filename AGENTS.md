...
- ShineGame-created guide images use one subtle diagonal `ShineGame.Pro` watermark in the middle content area. Keep the header and QR area clean, and do not add this watermark to collected external originals or direct translations derived from them.
