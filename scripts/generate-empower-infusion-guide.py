...
ROWS = [
    ...
    ("2", "3", "受到治疗效果提高 15%", "受疗效果 +22%", "自身受到治疗时，为当前生命最低的 1 名友方提供等同自身攻击力 800% 的护盾"),
    ...
    ("5", "3", "无基础效果", "压制：普通攻击或主动技能命中目标时，对生命低于自身的目标额外造成 1300% 攻击伤害", "普通攻击或主动技能对生命低于 50% 的敌人造成伤害时，额外造成其已损失生命值 10% 的伤害，上限 1500% 攻击"),
]
